  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'highlight-error': {
          '0%': { backgroundColor: 'rgba(239, 68, 68, 0.2)', borderColor: 'rgba(239, 68, 68, 0.5)' },
        ...
        textGlow: {
          '0%, 100%': {
            textShadow: '0 0 10px rgba(0, 212, 255, 0.3), 0 0 20px rgba(0, 212, 255, 0.2), 0 0 30px rgba(0, 212, 255, 0.1)',
          },
          '50%': {
            textShadow: '0 0 15px rgba(0, 212, 255, 0.5), 0 0 30px rgba(0, 212, 255, 0.3), 0 0 45px rgba(0, 212, 255, 0.2)',
          },
        },
      },
      fontSize: {
