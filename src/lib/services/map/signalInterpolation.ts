...
export class SignalInterpolator {
   ...
   */
  private bilinearInterpolate(_lat: number, _lon: number, _corners: { q11: InterpolationPoint; q12: InterpolationPoint; q21: InterpolationPoint; q22: InterpolationPoint }): number {
