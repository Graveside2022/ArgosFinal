...
// Removed unused variables: cycleCountdown, cycleInterval
let cycleTimer = null;
...
// Removed unused function: updateRemoveButtons
...
async function startSweep(initiationType = 'unknown') {
    ...
    try {
        ...
        if (response.ok) {
            ...
            const errorMessage = responseData.error || 'Failed to start sweep';
...
async function stopSweep() {
    ...
    try {
        ...
        if (response.ok) {
            ...
            if (responseData.error && responseData.error.includes('No sweep is running')) {
                // Backend says no sweep running, so just reset UI state
                resetScanningState();
                showStatus('No sweep was running on server - UI state reset', 'info');
            } else {
                throw new Error(responseData.error || 'Failed to stop sweep');
            }
        }
    } catch (error) {
...
function connectSSE() {
    ...
    eventSource.addEventListener('status_change', (event) => {
        ...
        // eslint-disable-next-line no-unused-vars
            ...
            // console.error('Error parsing status change:', _error);
        }
    });
    ...
    eventSource.addEventListener('cycle_config', (event) => {
        ...
        // eslint-disable-next-line no-unused-vars
            ...
            // console.error('Error parsing cycle config:', _error);
        }
    });
    ...
    eventSource.addEventListener('error', (event) => {
        ...
        // eslint-disable-next-line no-unused-vars
            ...
            // console.error('Error parsing error event:', _error);
    ...
    eventSource.addEventListener('emergency_stop', (event) => {
        try {
            const __responseData = JSON.parse(event.data);
        ...
        // eslint-disable-next-line no-unused-vars
            ...
            // console.error('Error parsing emergency_stop event:', _error);
        }
    });
    ...
    eventSource.addEventListener('server_reset', (event) => {
        ...
        // eslint-disable-next-line no-unused-vars
            ...
            // console.error('Error parsing server_reset event:', _error);
        }
    });
    ...
    eventSource.addEventListener('state_sync', (event) => {
        ...
        // eslint-disable-next-line no-unused-vars
            ...
            // console.error('Error parsing state_sync event:', _error);
        }
    });
    ...
    eventSource.addEventListener('stuck_recovery_attempted', (event) => {
        ...
        // eslint-disable-next-line no-unused-vars
            ...
            // console.error('Error parsing stuck_recovery_attempted event:', _error);
        }
    });
    ...
    eventSource.addEventListener('stuck_recovery_successful', (event) => {
        ...
        // eslint-disable-next-line no-unused-vars
            ...
            // console.error('Error parsing stuck_recovery_successful event:', _error);
        }
    });
    ...
    eventSource.addEventListener('stuck_recovery_failed', (event) => {
        ...
        // eslint-disable-next-line no-unused-vars
            ...
            // console.error('Error parsing stuck_recovery_failed event:', _error);
        }
    });
    ...
    eventSource.addEventListener('cycling_error', (event) => {
        ...
        // eslint-disable-next-line no-unused-vars
            ...
            // console.error('Error parsing cycling_error event:', _error);
        }
    });
    ...
    eventSource.addEventListener('frequency_error', (event) => {
        ...
        // eslint-disable-next-line no-unused-vars
            ...
            // console.error('Error parsing frequency_error event:', _error);
        }
    });
    ...
    eventSource.addEventListener('graceful_stop', (event) => {
        ...
        // eslint-disable-next-line no-unused-vars
            ...
            // console.error('Error parsing graceful_stop event:', _error);
        }
    });
    ...
    eventSource.addEventListener('stuck_recovery_error', (event) => {
        ...
        // eslint-disable-next-line no-unused-vars
            ...
            // console.error('Error parsing stuck_recovery_error event:', _error);
        }
    });
...
// Removed unused function: updateButtonStatesFromServerState
...
// Removed unused function: setCyclingPriority

// Removed unused function: isCyclingActive

// Removed unused function: shouldBypassSyncGuards
...
// Removed unused function: createCopyErrorButton
...
// Removed unused function: clearErrorStates
...
// Removed unused function: addDebugPanel

// Removed unused function: updateDebugInfo

// Removed unused function: copyDebugInfo

// Removed unused function: testConnection

// Get error history (simplified implementation)
// Removed unused function: getErrorHistory
...
async function performProactiveStateValidation() {
    ...
    // eslint-disable-next-line no-unused-vars
        ...
        // console.debug('State validation check failed (non-critical):', _error.message);
        return null;
    }
}
...
async function performQuickStateValidation() {
    ...
    // eslint-disable-next-line no-unused-vars
        ...
        // console.debug('Quick state validation failed (non-critical):', _error.message);
    }
}
